        ...
        <div className="alltransactionPage withdrawHistoryPage">
                ...
                <div className="gsTable">
                    <div className="tecTable">
                        <div className="tecHeader">
                            ...
                            <div className="tehItem dipositeWithdrwal"><img src="/images/depositWithrwalIcon.svg" alt="" width={26} /><span>Withdraw</span></div>
            ...
            {withdrawDetialsModalVisible && (
                <VeiwDetailsModal
                    ...
                    closeModal={() => {
                        setwithdrawDetialsModalVisible(false);
                        setselectewithdrawEntry(null);
                    }}
