...
export default function SignUp() {
    ...
    const handleSubmit = async () => {
        const { name, mobile, referralCode, email, password, confirmPassword } = formData;
        ...
        try {
            setLoading(true);
            const payload = { name, mobile, referralCode, email, password };
                        ...
                        <div className="lplForm">
                            ...
                            <div className="lplFormItem">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    maxLength={10} // Restrict max length to 10 for mobile number
                                />
                            </div>
                            <div className="lplFormItem">
